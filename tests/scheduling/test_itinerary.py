...
from trip_planner.enrichment.venue_operating_hours import OperatingHours
...
@patch("trip_planner.scheduling.itinerary.parse_operating_hours")
...
@patch("trip_planner.scheduling.itinerary.generate_standard_meal_description")
...
def test_standard_placeholder_meal_can_repeat_across_multiple_days():
    ...
    with patch("trip_planner.scheduling.itinerary.generate_standard_meal_description", return_value="Placeholder"):
        itinerary = assemble_itinerary(travel_info, [real_breakfast, standard_breakfast])
