...
from trip_planner.core.models import GeoLocation, Venue, VenueCandidate
from trip_planner.enrichment.serper_lookup import VenueLookupResult
from trip_planner.enrichment.venue_cost import VenueCost
from trip_planner.enrichment.venue_details import VenueDetails
from trip_planner.enrichment.venue_processing import _executor, process_venue, process_venues
...
@patch("trip_planner.enrichment.venue_processing.estimate_venue_cost")
@patch("trip_planner.enrichment.venue_processing.determine_meal_tags")
@patch("trip_planner.enrichment.venue_processing.estimate_duration_minutes")
@patch("trip_planner.enrichment.venue_processing.extract_venue_details")
@patch("trip_planner.enrichment.venue_processing.generate_description")
@patch("trip_planner.enrichment.venue_processing.lookup_venue")
...
@patch("trip_planner.enrichment.venue_processing.build_standard_venues")
@patch("trip_planner.enrichment.venue_processing.get_destination_geo_location")
@patch("trip_planner.enrichment.venue_processing.estimate_venue_cost")
@patch("trip_planner.enrichment.venue_processing.estimate_duration_minutes")
@patch("trip_planner.enrichment.venue_processing.extract_venue_details")
@patch("trip_planner.enrichment.venue_processing.generate_description")
...
def test_process_venues_collects_errors_without_aborting_others(
    ...
    with patch("trip_planner.enrichment.venue_processing.process_venue", side_effect=fake_process_venue):
        venues, errors = process_venues(_TRAVEL_INFO, candidates)
...
def test_process_venues_collects_errors_from_description_generation_failures(
    ...
    with patch(
        "trip_planner.enrichment.venue_processing.generate_description", side_effect=fake_generate_description
    ):
        venues, errors = process_venues(_TRAVEL_INFO, candidates)
...
@patch("trip_planner.enrichment.venue_processing.build_standard_venues")
@patch("trip_planner.enrichment.venue_processing.resolve_duplicate_venues")
@patch("trip_planner.enrichment.venue_processing.get_destination_geo_location")
@patch("trip_planner.enrichment.venue_processing.estimate_venue_cost")
@patch("trip_planner.enrichment.venue_processing.estimate_duration_minutes")
@patch("trip_planner.enrichment.venue_processing.extract_venue_details")
