...
from trip_planner.ui.ui import (
    _fmt_date,
    _itinerary_to_html,
    _progress_html,
    _render_day,
...
from trip_planner.core.models import Itinerary, ItineraryDay, ScheduledVenue
...
@patch("trip_planner.ui.ui.is_valid_destination", return_value=False)
...
@patch("trip_planner.ui.ui.create_itinerary")
@patch("trip_planner.ui.ui.is_valid_destination", return_value=True)
...
def test_on_schedule_itinerary_advances_stepper_through_stages(
    ...
    monkeypatch.setattr("trip_planner.ui.ui._POLL_INTERVAL_SECONDS", 0.01)
...
@patch("trip_planner.ui.ui.create_itinerary", side_effect=RuntimeError("boom"))
@patch("trip_planner.ui.ui.is_valid_destination", return_value=True)
