...
from trip_planner.ui.validation import is_valid_destination, validate_form
...
@patch("trip_planner.ui.validation.chat_completion", return_value="Yes")
def test_is_valid_destination_returns_true_for_yes(mock_chat_completion):
    assert is_valid_destination("Tucson, AZ") is True


@patch("trip_planner.ui.validation.chat_completion", return_value="No")
